...
# تبدیل اعداد به فونت ریز (بالانویس)
SMALL = str.maketrans('0123456789:', '⁰¹²³⁴⁵⁶⁷⁸⁹ː')
CLOCK_RE = re.compile(r'[\s⁰¹²³⁴⁵⁶⁷⁸⁹ː]+$')

def small_time():
    tz = timezone(timedelta(hours=3, minutes=30))  # ساعت تهران
...
async def help_cmd(event):
    await event.edit('🤖 /ping | /save | /del | /ghost on|off | /clock on|off')
